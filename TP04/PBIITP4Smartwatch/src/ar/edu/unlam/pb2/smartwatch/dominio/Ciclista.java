...
public class Ciclista extends Deportista {
	...
	public Ciclista(String nombre, int edadActual, double pesoActual, double alturaActual) {
		super(nombre, edadActual, pesoActual, alturaActual);
		this.disciplina = Disciplina.CICLISMO;
	...
	public void configurarZonasDeFrecuenciaCardiaca(Disciplina disciplina) {
		...
		if(disciplina.equals(Disciplina.CICLISMO)) {	
			valorMinimo = 50;
			valorMaximo = 55;
	...
	public String toString() {
		return "[Distancia: " + this.getDistanciaRecorrida() + " km" + ", Tiempo: " + this.getTiempoTranscurrido() + ", Velocidad: " + this.getVelocidad() + " km/h"
				+ ", Zona de frecuencia cardíaca: " + this.getZonaFrecuenciaCardiacaActual() + ", Cadencia: " + this.getCadencia() + " rpm" + "]";	
	}
}